...
//    $upass=$_POST['txtUserPass'];
    ...
    try
    {
        ...
        for($i=0;$i<$res->num_rows;$i++)
        {
            ...
            {
               header('location:forgorPasswordAdmin3.php');
...
//                array_push($errors,"You hava entered inncorrect code !!!");
            }
...
<!--                        --><?php //   }     ?>
                        ...
                        <form action="forgotPasswordAdmin2.php" method="post">
                            ...
                            <div class="text-center">
                                ...
                                <input name="continueButton" class="btn btn-primary" type="submit" style="width: 290px;border-radius: 50px"  value="Contniue">
