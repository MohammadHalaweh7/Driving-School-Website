...
<!--                            <a href="../mainPage.html" class="nav-link dropdown-toggle" data-toggle="dropdown"></a>-->
...
<!--    <img  style="margin-left: 0px; position: relative;position: absolute" width="380" src="../images/addMeeting4.gif" alt="">-->

    <img  style="margin-left: 1100px; position: relative;position: absolute" width="350" src="../images/AdminLogin.gif" alt="">

<div style="position: absolute;margin-left: 400px ;position: relative">
    ...
    <table >
        ...
        if($result->num_rows >0)
        {
            ...
            {
                echo "<tr><td>" . $row["MeetingNumber"] . "</td><td>".$row["EmployeeID"] . "</td><td>".$row["StudentID"] . "</td><td>".$row["VehicleNumber"] . "</td><td>".$row["MeetingDate"] . "</td><tr>";
            }
        }
        else
        {
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM"
    ...
    <div align="right">
        ...
        <button class="btn btn-primary" type="submit" style="border-radius: 50px;width: 150px;border: none;background-color: #172035">
            <a  href="DeleteMeeting.php" style="text-decoration:none ;color: white">   Delete Meeting </a>
        </button>



        <button class="btn btn-primary" type="submit" style="border-radius: 50px;width: 150px;background-color: #172035;border: none">
            <a href="AddMeeting.php"style="text-decoration:none ;color: white">    Add Meeting  </a>
        </button>
