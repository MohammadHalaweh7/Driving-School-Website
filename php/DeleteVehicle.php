...
{
    $ID = $_POST['ID'];
    $query = "DELETE FROM `vehiclestable` WHERE IDOfVehicle='$ID' ";
...
<div class="outerdiv" style="padding-top: 100px;margin-bottom: 178px">
    <div class="container my-5" >
        <img  style="margin-left: 860px; position: relative;position: absolute;padding:10px "  width="440" src="../images/AddVechile1.png" alt="">
                    ...
                    <div class="card-body">
                        ...
                        <form action="DeleteVehicle.php" method="post">
                            ...
                            <div class="from-group row">
                                ...
                                <label for="Vehicle ID" class="col-form-label col-12">
                                    Vehicle ID
                                </label>
...
<!--                                    <a href="AdminVehicleMainPage.php"style="text-decoration:none ;color: white">    Delete  </a>-->
<!--                                </button>-->
