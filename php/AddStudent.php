...
if(isset($_POST['Sign_Up']))
{
    ...
    $TypeOfLicense=$_POST['txtTypeOfLicense'];
    ...
    $query = "INSERT INTO studentstable2 (FullName,ID,PhoneNumber,BirthOfDate,Gender,TypeOfLicense,Email, Password, ConfirmPassword)
 VALUES ('$FullName','$ID','$PhoneNumber','$BirthOfDate','$Gender','$TypeOfLicense','$Email',SHA1('".$Password."'),SHA1('".$ConfirmPassword."'))";
    $query_run = mysqli_query($con,$query);

    if($query_run)
    {
        $_SESSION['status'] = "done save";
        header('location:AdminStudentMainPage.php');
    }
    else
    {
...
<div class="container my-5" style="">
    <img  style="margin-left: 860px; position: relative;position: absolute;padding:10px "  width="420" src="../images/StudentsMain%20Page1.png" alt="">
                ...
                <div class="card-body">
                    ...
                    <form action="AddStudent.php" method="post">
                        ...
                        <div class="from-group row">
                            ...
                            <label for="license" class="col-form-label col-12">
                                Type of license
                            </label>

                            <div class="col-12">
                                <select name="txtTypeOfLicense" id="license" class="form-control">
                                    <option  selected disabled></option>
                                    <option >Car</option>
                                    <option >Bus</option>
                                    <option >Motor</option>
                        ...
                        <div align="right">
                            ...
                            <button class="btn btn-primary" type="submit" style="border-radius: 50px;width: 150px;background-color: #172035">
                                <a  href="AdminStudentMainPage.php" style="text-decoration:none ;color: white">   Cancel </a>
                            </button>
...
<!--                                <a href="AdminStudentMainPage.php"style="text-decoration:none ;color: white">    Add  </a>-->
<!--                            </button>-->
