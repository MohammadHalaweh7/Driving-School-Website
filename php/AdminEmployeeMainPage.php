...
<div class="table-box" >
    <img  style="margin-left: 960px; position: relative;position: absolute;padding:10px " width="500" src="../images/AddEmployee3.gif" alt="">
...
<!--                <th>Confirm Password</th>-->
            ...
            if($result->num_rows >0)
            {
                ...
                {
                    echo "<tr><td>" . $row["FullName"] . "</td><td>".$row["ID"] . "</td><td>".$row["Adress"] . "</td><td>".$row["PhoneNumber"] . "</td><td>".$row["BirthOfDate"]. "</td><td>".$row["Gender"]. "</td><td>".$row["StartDate"]. "</td><td>".$row["Email"]. "</td><tr>";
                }
            }
            else
            {
...
<br>
    ...
    <div align="right">
        <button class="btn btn-primary" type="submit" style="border-radius: 50px;width: 150px;background-color: #172035;border: none">
            <a  href="DeleteEmployee.php" style="text-decoration:none ;color: white">Delete Employe </a>
        </button>

        <button class="btn btn-primary" type="submit" style="border-radius: 50px;width: 150px;background-color: #172035;border: none">
            <a href="AddEmployee.php"style="text-decoration:none ;color: white">    Add    Employee  </a>
        </button>
    </div>
