...
{
    $ID = $_POST['ID'];
    $query = "DELETE FROM `studentstable2` WHERE ID='$ID' ";
...
<div class="outerdiv" style="padding-top: 100px;margin-bottom: 178px">
    <div class="container my-5" >
        <img  style="margin-left: 820px; position: relative;position: absolute;padding:10px " width="500" src="../images/DeleteStudent1.png" alt="">
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                            ...
                            <div align="right">
                                ...
                                <input class="btn btn-primary" style="width: 150px;border-radius: 50px;background-color: #172035" type="submit" name="delete" value="Delete">


<!--                                <button class="btn btn-primary" type="submit" style="border-radius: 50px;width: 150px">-->
<!--                                    <a href="AdminStudentMainPage.php"style="text-decoration:none ;color: white">    Delete  </a>-->
<!--                                </button>-->
