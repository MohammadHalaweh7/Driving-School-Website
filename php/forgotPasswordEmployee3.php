    ...
    try
    {
        ...
        for($i=0;$i<$res->num_rows;$i++)
        {
            ...
            if ( $uname==$upass)
            {
                ...
                header('location:forgotPasswordEmployee4.php');
            }
            else
            {
            ...
            <div class="col-12 col-md-6 offset-0 offset-md-3">
                <div class="card shadow border shadow-lg">
                    <div class="card-body">
                        ...
                        <form action="forgotPasswordEmployee3.php" method="post">
                            <div class="from-group row">
                                ...
                                <div class="col-12">
                                    <input type="password" name="txtUserLogin" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="text-center">
                                ...
                                <input class="btn btn-primary" type="submit" style="width: 290px;border-radius: 50px"  value="Change">
